        ...
        const participantList = details.participants.length > 0
          ? details.participants.map((participant) => `
              <li>
                ...
                <button type="button" class="remove-participant" data-email="${encodeURIComponent(participant)}" aria-label="Remove ${participant}" title="Remove participant">&times;</button>
              </li>
            `).join("")
